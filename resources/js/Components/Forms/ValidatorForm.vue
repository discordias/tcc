            ...
            <form @submit.prevent="salvar" class="px-4 py-5">
                <div class="grid grid-cols-4 gap-4 mb-4">
                    <div class="col-span-2">
                        ...
                        <input type="text" class="w-full" id="validator_name" maxlength="100" required v-model="form.name" autofocus/>
                    </div>
                    <div class="col-span-2">
                        <label for="validator_email">E-mail</label>
                        <input type="email" class="w-full" id="validator_email" maxlength="50" required v-model="form.email" autofocus/>
                    </div>
                </div>
