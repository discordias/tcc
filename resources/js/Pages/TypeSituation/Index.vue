    ...
    <layout>
        <div class="flex justify-between">
            ...
            <inertia-link
              ...
              :href="this.route('typeSituations.create')"
                ...
                <div class="bg-white shadow-md rounded my-6">
                    <table class="min-w-max w-full table-auto">
                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                            <tr v-for="typeSituation in typeSituations.data" key="axle.id" class="border-b border-gray-200 hover:bg-gray-100">
                                ...
                                <td class="py-4 px-6 text-center">
                                    <inertia-link
                                        ...
                                        :href="this.route('typeSituations.edit', typeSituation.id)"
                    ...
                    <div class="px-6 pb-4 bg-white">
                        <pagination :data="typeSituations" />
                    </div>
                </div>
            </div>
